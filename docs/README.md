...
```bash
# Clone and install all agents to Claude Code
...
**Supported tools:** `claude-code` | `copilot` | `cursor` | `aider` | `windsurf` | `all`

Run `./scripts/install.sh --tool all` to install to all supported tools at once!
